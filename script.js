// ================================================================
// Web Simulasi Simplified DES (S-DES)
// Format tampilan langkah dibuat seperti materi perhitungan tabel.
// ================================================================
...
exampleBtn.addEventListener("click", function () {
  ...
  // Contoh mengikuti materi: plaintext 00101000 dengan key 1100011110
  // menghasilkan ciphertext 10001010. Jika mode dekripsi dipilih,
  // aplikasi otomatis mengisi ciphertext tersebut agar hasilnya kembali ke plaintext.
  keyBitsEl.value = "1100011110";

  if (mode === "decrypt") {
    inputBitsEl.value = "10001010";
  } else {
    inputBitsEl.value = "00101000";
  }
